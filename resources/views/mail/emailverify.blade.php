...
<html>
   ...
   <body>
      <div style="max-width:720px; margin:0 auto;">
          <div style="/*width:620px;*/background: #ffccff; /*padding: 0px 10px;*/ border:1px solid #dcd7d7;">
            <div style="float: none; text-align: center; margin-top: 0px; background:url('{{ URL::to('#') }}') repeat center center">              
              <!--  <img src="https://onepatch.com/wp-content/uploads/2021/03/ONEPATCH_LOGO_2020_RESIZE.png" width="120" alt=""> -->
              <p>OpWebTracker</p>
            </div>
         </div>
         <div style="max-width:700px; border:1px solid #dcd7d7; margin:0 0; padding:15px; border-top:none;">
            ...
            <div style="display:block; overflow:hidden; width:100%;">
               <p style="font-family:Arial; font-size:14px; font-weight:500; color:#000;margin-left: 5px;">
                  Welcome to OPWebTracker,Please click the verify email to verify your registered email.
               </p>  
               <div style="display:block;overflow:hidden; width:100%; text-align:center; margin: 0px 0px 10px 0px;">

                  <a href="{{ route('user.verify', [@$data['email_vcode'],md5(@$data['id'])]) }}" style="font-family:Arial; border-radius:17px;font-size:15px; font-weight:500; color:#FFF; display:inline-block; padding: 7px 12px; background:#e69904; text-decoration:none;">Verify Email</a>
               </div>               
            </div> 
            ...
            <p style=" font-family:Arial; font-size:14px; font-weight:500; color:#363839;margin: 0px 0px 10px 0px;">Team OpwebTracker.</p>
         ...
         <div style="/*width:620px;*/background:#ffccff; /*padding: 0px 10px;*/ border:1px solid #dcd7d7;">
            <div id="sub-footer">
                <div class="row footer_row">
                    <div class="column">OPConnect© 2021. All Rights Reserved.</div>
